...
export function useDemoShell() {
  const meta = [
    ...
    { title: '采购合同报表管理', file: 'purchase-summary-report.html', group: 'purchase' },
    ...
    { title: '物资列表', file: 'sales-material-list.html', group: 'other' },
    { title: '订单管理', file: 'sales-order-management.html', group: 'other' },
    { title: '购入物资', file: 'sales-purchased-materials.html', group: 'other' },
    { title: '销售合同报表管理', file: 'sales-contract-report.html', group: 'other' },
  ];
  ...
  const actionToFile = {
    ...
    'bd-warehouse-orientation': 'bd-warehouse-orientation.html',
    ...
    'sales-material-list': 'sales-material-list.html',
    'sales-order-manage': 'sales-order-management.html',
    'sales-purchase-material': 'sales-purchased-materials.html',
    ...
    'warehouse-checkout': 'material-procurement-hub.html?tab=m10',
    'warehouse-io-ledger': 'warehouse-io-ledger.html',
    'warehouse-stock-ledger': 'warehouse-stock-ledger.html',
    'warehouse-transfer': 'material-procurement-hub.html?tab=m10',
  };
  ...
  const labelToFile = {
    ...
    '库存管理': 'material-procurement-hub.html?tab=m10',
    ...
    '采购合同报表管理': 'purchase-summary-report.html',
    '销售合同报表管理': 'sales-contract-report.html',
    '物资列表': 'sales-material-list.html',
    '购入物资': 'sales-purchased-materials.html',
